...
public abstract class ValueMapTest extends AbstractGremlinProcessTest {
    ...
    public abstract Traversal<Vertex, Map<String, List>> get_g_VX1X_outXcreatedX_valueMap(final Object v1Id);
    ...
    public void g_VX1X_outXcreatedX_valueMap() {
        final Traversal<Vertex, Map<String, List>> traversal = get_g_VX1X_outXcreatedX_valueMap(convertToVertexId("marko"));
        printTraversalForm(traversal);
    ...
    public static class Traversals extends ValueMapTest {
        ...
        @Override
        public Traversal<Vertex, Map<String, List>> get_g_VX1X_outXcreatedX_valueMap(final Object v1Id) {
